...
{
 unsigned char adcbyt[3][8]={
  {0x89,0x99,0xa9,0xb9,0xc9,0xd9,0xe9,0xf9},
  {0x89,0x99,0xa9,0xb9,0xc9,0xd9,0xe9,0xf9},
  {0x85,0x95,0xa5,0xb5,0xc5,0xd5,0xe5,0xf5}
 };

 unsigned char adcreg[5]={0x00,0x0e,0x0d,0x0b,0x07};
...
void VMEController::lowvolt(int ichp,int ichn,char *rcv)
{
 ...
 unsigned char lowvreg[10]={0x10,0x00,0x01,0x02,0x03,0x04,0x05,0x06,0x11,0x12};
 unsigned int ptr;
 unsigned short int val[2];
 unsigned short int tmp[2]={0x0000,0x0000}; 
...
unsigned int ptr;
 ...
 if (headtail==3) x01[0]=0x01;
 if (headtail==3) x03[0]=0x03;
 if (headtail==0) x01[0]=0x00;
 if (headtail==0) x03[0]=0x02;
 if (headtail==3) x01[0]=0x01;
 if (headtail==3) x03[0]=0x03;
