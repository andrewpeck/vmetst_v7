...
//------------------------------------------------------------------------------
//	common/step_com/line_store(80,mxframes)
//	byte line_store
//
//	common/jtag_common/jtaglogmode,jtaglogunit
//	logical*4	jtaglogmode
//	integer*4	jtaglogunit
...
//!	if(jtaglogmode) write(jtaglogunit,'(z4.4)')jtag_word
...
//!	if(step_mode.ne.0)write(*,'(1x,40A1)')(line_store(i,iframe),i=1,40)
	...
	wr_data  = jtag_out;
	status   = vme_write(adr,wr_data);				//Write boot reg
//!	if(jtaglogmode) write(jtaglogunit,'(z4.4)')jtag_out
